...
Adaptive \textbf{mathematical programmer} skilled in C \& C++ with MPI that has contributed to many state-of-the-art software libraries as well as multiple linear \& nonlinear solvers. Invited to Cambridge, England \& Heidelberg, Germany to do analysis as well as develop more efficient, reliable code for people accomplishing incredible things within the scientific community.  Looking to start a career in the D.C. metro area in INSERT JOB AREA, as my other half has recently received her dream job in Washington, D.C.
...
\begin{tabularx}{1.5\linewidth}{>{\raggedleft\scshape}p{3cm}X}
  ...
  \vspace{-2mm}
   ...
   \item Gained experience with Linux, version control, \& modern software engineering practices
   
   \item Presented over 12 contributed talks \& 2 posters, spoke at 2 panels, \& led 5 workshops
   \end{itemize}  
...
\item \textbf{M.S., Applied Mathematics}, Indiana University of Pennsylvania  \hspace{12 mm} \textit{2013} \hspace{2mm} \textbf{QPA: 3.83}/4.00
   ...
   \item Completed multiple projects in modeling \& simulation, linear optimization, \& statistics
   \end{itemize}  
...
\item \textbf{B.S., Physics}, Indiana University of Pennsylvania  \hspace{39 mm}\textit{2012} \hspace{2 mm} \textbf{QPA: 3.95}/4.00
    \vspace{-2mm}
     \begin{itemize}
         \setlength\itemsep{.005em}
   \item Received an equivalent degree in applied mathematics as well as a minor in computer science 
