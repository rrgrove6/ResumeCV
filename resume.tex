...
\begin{tabularx}{1.5\linewidth}{>{\raggedleft\scshape}p{3cm}X}
  ...
  \item \textbf{\textit{Ph.D., Mathematical Sciences, Clemson University}}  \hspace{44 mm} \textit{2017(expected)}
             ...
             Thesis area: Finite element method, geometric multigrid, and parallelization \textbf{QPA: 3.76/4.00}
...
Spring 2016 - Spring 2017: Teach MATH 1080 (Calculus of One Variable II)
...
Researched three-field Stokes flow to model melt migration
...
\begin{tabularx}{1.5\linewidth}{>{\raggedleft\scshape}p{3cm}X}
  ...
  &\begin{itemize}
    \setlength\itemsep{.005em}
                             \item \textbf{\textit{GSG Finance Committee Chair, Clemson University}}    \hspace{30 mm}\textit{Aug 2015 - present}
  
   
   Also serving as a Graduate Student Government (GSG) senator
